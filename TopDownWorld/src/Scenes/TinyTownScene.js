class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        document.getElementById('description').innerHTML = '<h2>Welcome to Awesome Town!</h2>'
        ...
        this.otherLayer = this.map.createLayer("Other", this.tileset, 0, 0);

        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.otherLayer.setScale(4.0);
    }
