class Path extends Phaser.Scene {
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.oKey)) {
            ...
            let output = [];
            for(let i of this.curve.points){
                output.push(i);
            }
            console.log(output);
        ...
        if (Phaser.Input.Keyboard.JustDown(this.rKey)) {
            ...
            if(this.runMode === true){
                ...
                this.runMode = true;
                if(this.curve.points != undefined){
                    my.sprite.enemyShip.x = this.curve.points[0].x;
                    my.sprite.enemyShip.y = this.curve.points[0].y;
                }
                my.sprite.enemyShip.visible = true;
                my.sprite.enemyShip.startFollow({from: 0, to: 1, delay: 0, duration: 2000,
                ease: 'Sine.easeInOut', repeat: -1, yoyo: true,  rotateToPath: true,   rotationOffset: -90});
            }
            //
            // TODO: 
            // Implement run mode
