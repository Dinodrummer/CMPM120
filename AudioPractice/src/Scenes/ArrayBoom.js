class ArrayBoom extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio("impact", "impactMetal_light_003.ogg");
        this.load.audio("background", "background_music.mp3");
    }
    ...
    create() {
        ...
        my.sprite.impact = this.sound.add("impact");
        my.sprite.music = this.sound.add("background", {
            loop: true,
            volume: 0.5
        });
